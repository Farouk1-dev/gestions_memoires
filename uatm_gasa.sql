-- ============================================
-- UATM GASA — Base de données complète
-- Importer dans phpMyAdmin > onglet SQL
-- ============================================
...
-- Mémoires
INSERT INTO memoires (titre, statut, etudiant_id, professeur_id, filiere_id, date_creation, date_soumission) VALUES
...
('Étude sur l\'intelligence artificielle',   'soumis',     4, 6, 3, '2024-05-09 00:00:00', '2024-05-09 16:45:00'),
('Application de gestion de bibliothèque',   'soumis',     5, 6, 2, '2024-05-09 00:00:00', '2024-05-09 08:10:00');

-- Notifications
INSERT INTO notifications (utilisateur_id, message, type, lu) VALUES
...
(6, 'Nouveau mémoire soumis par Koffi ADJOUMANI.', 'info', 0);
